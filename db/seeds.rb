...
User.create!({name: "Laura Smith",username:"jsmith", password:"lsPrfv", image_url: "j5ztl7flo583isotukyg", title: "Founder, Instagram"})
User.create!({name: "David Parrott", username:"elgarant", password:"kBW7CS", image_url: "wk95n67gqxsumhujyhbm", title: "PM at Soundcloud"})
User.create!({name: "Peter Cline", username:"ksong", password:"sports", image_url: "wip0pwaobkgj92zkmgur", title: "Dev"})
User.create!({name: "Anthony Little", username:"johnk", password:"7bgQVT", image_url: "hszse0wnmqc3ljkb7wdf"})
User.create!({name: "Denise Chalmers", username:"kyseb", password:"svgoLN", image_url: "y6ydes4ifpuvaa02upyz", title: "Social Media Specialist"})
User.create!({name: "James Sieber", username:"mattbar", password:"wildflowe", image_url: "yq1cd0dovyrwzrpdmmjp", title: "iOS Developer"})
User.create!({name: "Kevin Wilson", username:"mikek", password:"Lg0LTV", image_url: "bzmjwsjgtnqtzmpta2az"})
User.create!({name: "Jonathan Battaglia", username:"sv_zee", password:"uIbIQm", image_url: "gxcokxm7wnn3zif234xj"})
User.create!({name: "Cheryl Atkins", username:"cbarrett", password:"ugyDku", image_url: "qopb4pzy3f0zbrmyohwx", title: "Product Quest"})
User.create!({name: "Kris Ealey", username:"hacahoi", password:"Y1TR3L", image_url: "wxmhoumhvbxnp6wrjwsr", title: "UX Designer"})
User.create!({name: "Frank Harrison", username:"hachsdfoi", password:"Y1TR3L", image_url: "lpljnqpo7w6ptkqsscwb", title: "UX Designer"})
User.create!({name: "June Thomas", username:"hasadchoi", password:"Y1TR3L", image_url: "fk1wjznjri8r1fszt5x7", title: "UX Designer"})
User.create!({name: "Mary Tolbert", username:"df", password:"Y1TR3L", image_url: "ag8u7d6dh0mpbv3psnr9", title: "UX Designer"})
User.create!({name: "Alex Spaeth", username:"hactwehoi", password:"Y1TR3L", image_url: "nxuiton66ly88tvug4jc", title: "UX Designer"})
User.create!({name: "Peter Newman", username:"hacwethoi", password:"Y1TR3L", image_url: "fcutxsqoqnwadp6jq2mt", title: "UX Designer"})
User.create!({name: "Tara Fletcher", username:"dfhacdhoi", password:"Y1TR3L", image_url: "kuvhsotu3v25xpsd7ey0", title: "UX Designer"})
User.create!({name: "Robert Glover", username:"hacsadfhoi", password:"Y1TR3L", image_url: "kt0jrwprefkkz4mg60l4", title: "UX Designer"})
User.create!({name: "Willis Rowe", username:"hacdhoi", password:"Y1TR3L", image_url: "az3y8qwlvpt3glhhs2cp", title: "UX Designer"})
User.create!({name: "Christina Jones",username:"hactewhoi", password:"Y1TR3L", image_url: "m5asgerb5l7vd3gvyx5l", title: "UX Designer"})
User.create!({name: "Rose Kendrick", username:"hacsdfhsdoi", password:"Y1TR3L", image_url: "eevxu7ipvovgenxlf11y", title: "UX Designer"})
User.create!({name: "Joe Young", username:"hachq23oi", password:"Y1TR3L", image_url: "jbsusczj8vx6owgdzae9", title: "UX Designer"})
User.create!({name: "Charles McCurry",username:"hachwwoi", password:"Y1TR3L", image_url: "fznbr451fppy2l4cfctr", title: "UX Designer"})
User.create!({name: "Lauren Peters",username:"hacswdfhoi", password:"Y1TR3L", image_url: "cnczvsgrnp2cferbltwa", title: "UX Designer"})
User.create!({name: "David Hammnd", username:"43", password:"Y1TR3L", image_url: "c7fm3q3dnejfkx5jfrfc", title: "UX Designer"})
User.create!({name: "Ava Fisher", username:"hachafoi", password:"Y1TR3L", image_url: "jpmaiwwg5q92j2xormz7", title: "UX Designer"})
User.create!({name: "Mia Rosenberg",username:"hacy4sdfhoi", password:"Y1TR3L", image_url: "ybibawwnhrixi0slxfzk", title: "UX Designer"})
User.create!({name: "Clayton Wagner",username:"hachewroi", password:"Y1TR3L", image_url: "z9gbtlua5edw9mbj1qb9", title: "UX Designer"})
User.create!({name: "Karen Woods",username:"hach4wt4oi", password:"Y1TR3L", image_url: "muzhtjs0ekxy5iaem3o6", title: "UX Designer"})
User.create!({name: "Randy Reeve",username:"ffff", password:"Y1TR3L", image_url: "miarspxtvm2uv0hhnbz7", title: "UX Designer"})
User.create!({name: "Margie Griffin",username:"hachsdsfoihoi", password:"Y1TR3L", image_url: "zc3ep21bfxyxgalmyomz", title: "UX Designer"})
...
Discussion.create!({body: "I tried so many different apps to eliminate the finding a time back and forth nonsense.

It looks good and I really like what Sunrise has done with the calendar so far.", author_id: 11 , product_id: 2})
...
Discussion.create!({body: "Pioneering new ways of leveraging custom keyboards. Congrats Sunrise team!", author_id: 17 , product_id: 2})
Discussion.create!({body: "Wow, excellent, ground breaking work! Bravo team! Looks like it currently only works one-on-one (or am I missing something?) any thoughts about enabling for groups?", author_id: 22, product_id: 2})
