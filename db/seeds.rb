...
User.create!({username:"jsmith", password:"lsPrfv", image_url: "qivgdv3nnugtbfpjsi9x"})
User.create!({username:"elgarant", password:"kBW7CS", image_url: "qivgdv3nnugtbfpjsi9x"})
User.create!({username:"ksong", password:"sports", image_url: "qivgdv3nnugtbfpjsi9x"})
User.create!({username:"johnk", password:"7bgQVT", image_url: "qivgdv3nnugtbfpjsi9x"})
User.create!({username:"kyseb", password:"svgoLN", image_url: "qivgdv3nnugtbfpjsi9x"})
User.create!({username:"mattbar", password:"wildflowe", image_url: "qivgdv3nnugtbfpjsi9x"})
...
User.create!({username:"cbarrett", password:"ugyDku", image_url: "qivgdv3nnugtbfpjsi9x"})
User.create!({username:"hachoi", password:"Y1TR3L", image_url: "qivgdv3nnugtbfpjsi9x"})
